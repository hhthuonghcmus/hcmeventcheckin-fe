...
@Component({
  ...
  imports: [RippleModule, CommonModule, ChartModule, BaseChartDirective],
...
export class ManageEventVotingStatisticComponent {
  ...
  getChartDatasets(questionId: string) {
    ...
    const votedPhoneNumbers = this.votes
  ...
  getCharData(questionId: string) {
    ...
    question.answers.forEach((answer, i) => {
      ...
      labels.push(
        this.eventService.getAlphabeticalTextOfAnswerIndex(i) +
